...
// logo.setAttribute('company', 'LIAS');
...
// btnScrollTo.addEventListener('click', function (e) {
//   const s1coords = section1.getBoundingClientRect(); // section 1
//   console.log(s1coords);
//   console.log(e.target.getBoundingClientRect()); // btn
//   console.log(
//     'Current scroll x, y',
//     window.pageXOffset,
//     window.AnimationpageYOffset
//   );
//   console.log(
//     'height/width viewport (X/Y)',
